...
This document provides guidelines for internationalization of the Shahbit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `shahbit_en.ts` remains unchanged.
