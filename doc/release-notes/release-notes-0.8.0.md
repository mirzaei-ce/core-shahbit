Shahbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/shahbit/files/Shahbit/shahbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Shahbit
...
New/changed settings (command-line or shahbit.conf file)
--------------------------------------------------------
