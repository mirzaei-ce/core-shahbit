Shahbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/shahbit/files/Shahbit/shahbit-0.5.4/
...
http://gitorious.org/shahbit/shahbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Shahbit-Qt notifications under Growl 1.3.
Increase required age of Shahbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxShahbit properly when installing Shahbit-Qt over it. (Windows)
