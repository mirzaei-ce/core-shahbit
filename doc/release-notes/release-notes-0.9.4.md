Shahbit Core version 0.9.4 is now available from:

  https://shahbit.org/bin/0.9.4/
...
this update is incompatible with the Shahbit system and could lead to consensus
forks.

Shahbit Core released binaries from https://shahbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~shahbit/+archive/ubuntu/shahbit
- A third-party or self-compiled Shahbit Core

upgrade to Shahbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
