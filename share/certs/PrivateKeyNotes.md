...
unlocked to sign the Shahbit-Qt.app bundle.
...
allowing somebody to distribute a Shahbit-Qt.app or shahbit-qt-setup.exe with a valid
...
that the shahbit-qt.exe file inside the installer had not been tampered with.
