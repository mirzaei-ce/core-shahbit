...
#ifndef SHAHBIT_QT_SHAHBITUNITS_H
#define SHAHBIT_QT_SHAHBITUNITS_H
...
/** Shahbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ShahbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ShahbitUnits(QObject *parent);

    /** Shahbit units.
      @note Source: https://en.shahbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SBT,
...
private:
    QList<ShahbitUnits::Unit> unitlist;
};
typedef ShahbitUnits::Unit ShahbitUnit;

#endif // SHAHBIT_QT_SHAHBITUNITS_H
