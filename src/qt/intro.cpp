...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/shahbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Shahbit Core"),
     ...
     * override -datadir in the shahbit.conf file in the default data directory
     * (to be consistent with shahbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
