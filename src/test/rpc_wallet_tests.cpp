...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CShahbitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CShahbitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CShahbitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CShahbitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CShahbitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CShahbitAddress(arr[0].get_str()).Get() == demoAddress.Get());
