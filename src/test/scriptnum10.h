...
#ifndef SHAHBIT_TEST_SCRIPTNUM10_H
#define SHAHBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Shahbit Core 0.10.0, for cross-comparison.
 */
public:
