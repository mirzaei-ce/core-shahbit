# mininode.py - Shahbit P2P network half-a-node
#
...
#
# NodeConn: an object which manages p2p connectivity to a shahbit node
...
# Objects that map to shahbitd objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in shahbitd indicates these should be deserialized as blocks
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest", services=1):
        ...
        print 'MiniNode: Connecting to Shahbit Node IP # ' + dstaddr + ':' \
            + str(dstport)
